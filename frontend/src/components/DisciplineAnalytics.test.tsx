...
const data: DisciplineAnalyticsData = {
  ...
  execution_discipline: { trades_opened: 0, trades_with_partial_exits: 0, partial_exit_rate: null, trades_with_runner_activated: 0, runner_without_stop_occurrences: 0, green_to_red_warning_occurrences: 0, average_number_of_exit_executions: null, auto_closed_trade_count: 0, trades_with_additions: 0, position_addition_rate: null, total_add_executions: 0, average_adds_per_trade_with_additions: null, adds_while_negative_count: 0, unconfirmed_reversal_adds_blocked: 0 },
