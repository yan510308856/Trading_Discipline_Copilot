...
export function TradeChecklist() {
  ...
  return <form className="trade-form trade-wizard" onSubmit={submit}>
    ...
    <div className={`wizard-step step-${step}`}>
      ...
      {step === 2 && <section>{planSummary}<h3>Setup & Context</h3>
